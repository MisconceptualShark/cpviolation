...
\abstract{
    In this study, we test the Two Higgs Doublet Model (2HDM) of Type II as an extension of the Standard Model (SM) using indicative flavour observables, such as leptonic decays of $B$ and $D$ mesons, $B\bar{B}$ mixing, the $b\to s\gamma$ radiative decay, and $B_q\to\mu^+\mu^-$.
    Testing the 2HDM parameter space $m_{H^+},\tan\beta$ to find alignment between theoretical calculations and experiment, constraints on the parameters were found for the above flavour phenomena both individually and then as a global fit. 
    We perform this fit in both the alignment and wrong sign limits of the 2HDM, the latter of which is to test validity for a future test of the SM4$\times$2HDM extension. 
    Strongly dominated by the $b\to s\gamma$ branching ratio, the mass of a charged Higgs particle would be expected to have a minimum value at 95\% CL exclusion of $490$ GeV in the alignment limit and $740$ GeV in the wrong sign limit.
    The value of $\tan\beta$ is constrained by $B_q\to\mu^+\mu^-$ decays, yielding maximum values at 95\% CL exclusion of $20.8$ in the alignment limit and $4.03$ in the wrong sign, for the fixed choices of other parameters. 
    ...
    The constraints of this combined fit are no more conclusive than flavour alone, due to additional parameter dependency in $S,T,U$; the only additional constraint we definitively find here is that $m_{H^+}\approx m_{H^)}\approx m_{A^0}$ in both the alignment and wrong sign limits.
    The validity of this fit is heavily influenced by the semileptonic ratio $\mathcal{R}(D^*)$, the statistical fit of these observables points to exclusion of this model at 95\% CL in the wrong sign limit, and 80\% CL in the alignment limit. 
}
...
\begin{table}[ht]
    ...
    \begin{tabular}{cc|C{2.4cm}|C{2.2cm}|C{1.8cm}|C{2.4cm}}
        ...
        \hline
        \multicolumn{2}{c|}{$\chi^2_{min}$} & $4.57$ & $5.70$ & $4.19$ & $4.30$ \\
        \multicolumn{2}{c|}{$\chi^2_{\nu}$} & $0.38$ & $0.38$ & $0.35$ & $0.29$ \\
        \multicolumn{2}{c|}{$\nu$} & $12$ & $15$ & $12$ & $15$ \\
        \multicolumn{2}{c|}{p-value} & $97.1\%$ & $98.0\%$ & $98.4\%$ & $99.7\%$ \\
        \hline\hline
    \end{tabular}
