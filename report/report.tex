...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,trim=0 2em 0 0]{bsgam.pdf}
...
\begin{table}[ht]
    ...
    \begin{tabular}{c|ccc}
        ...
        \hline\hline
        $\mathcal{B}[B\to\tau\nu]$ & $1.09\pm0.24$ & $10^{-4}$ & \cite{pdg} \\
        $\mathcal{B}[D\to\mu\nu]$ & $3.82\pm0.33$ & $10^{-4}$ & \cite{pdg} \\
        $\mathcal{B}[D_s\to\tau\nu]$ & $5.48\pm0.23$ & $10^{-2}$ & \cite{pdg} \\
        $\Gamma[K\to\mu\nu]/\Gamma[\pi\to\mu\nu]$ & $1.337\pm0.003$ & & \cite{pdg} \\
        $\Gamma[\tau\to K\nu]/\Gamma[\tau\to\pi\nu]$ & $6.438\pm0.094$ & $10^{-2}$ & \cite{pdg} \\
        $\Delta m_d$ & $0.5064\pm0.0019$ & $ps^{-1}$ & \cite{hflav} \\ 
        $\Delta m_s$ & $17.757\pm0.021$ & $ps^{-1}$ & \cite{hflav} \\
        $\mathcal{B}[\bar{B}\to X_s\gamma]$ & $3.32\pm0.15$ & $10^{-4}$ & \cite{hflav,bmes} \\
...
\begin{table}[ht]
    ...
    \begin{tabular}{c|ccc}
        ...
        $f_{B_s}$ & $230.3\pm1.3$ & MeV & \cite{flag} \\
        ...
        \hline\hline
        $\hat{B}_{B_d}$ & $1.268\pm0.042$ & & \cite{bmix} \\
        $\hat{B}_{B_s}$ & $1.290\pm0.035$ & & \cite{bmix} \\
        $\eta_B$ & $0.537856$ & & \cite{alex} \\
        \hline\hline
...
\begin{figure}[ht]
    ...
    \end{subfigure}
    \caption{\label{fig:glob1} Global fit of constraints on $m_{H+}$ and $\tan\beta$ from all observables considered. The green, blue, and coral regions represent constraints shown individually in figure \ref{fig:indies}, and the orange region is the global constraint to $1\sigma$.}
\end{figure}
In previous works, such as \cite{desc}, the global fit has extended to the very top of the parameter space, so it could not be ruled out that the allowed region did not extend higher. 
