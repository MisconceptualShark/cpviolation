...
\end{align}
However, generally, these cannot both be diagonalised simultaneously; this could be the case, but we do not start with this in case it is not so. %re-word mayhaps?
