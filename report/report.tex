...
\end{figure}
In previous works, such as \cite{a}, the global fit has extended to the very top of the the parameter space, so it could not be ruled out that the allowed region did not extend higher. 
