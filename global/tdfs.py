    ...
    for i in mHs:
        for j in tanbs:
            for k in mAs:
                ...
                expect_bs = bmumu(mt,tbs,fBs,Vtb,Vts,mmu,mbs,mW,j,i,mb,ms,mc,mu,wangle,higgs,vev,Vus,Vub,Vcs,Vcb,k,alph)
                expect_bs_uperr,expect_bs_downerr = error_bmumu(mt,mt_err,tbs,tbs_err,fBs,fBs_err,Vtb,Vtb_err,Vts,Vts_err,mmu,mmu_err,mbs,mbs_err,mW,mW_err,j,i,mb,mb_err,ms,ms_err,mc,mc_err,mu,mu_err,wangle,wangle_err,higgs,higgs_err,vev,vev_err,Vus,Vus_err,Vub,Vub_err,Vcs,Vcs_err,Vcb,Vcb_err,k,alph)
                ...
                if bs_bool and SOblique_bool and TOblique_bool and UOblique_bool:
                    ...
                    chit = chisq_simp([av_bsmu,av_SOblique,av_TOblique,av_UOblique],[mid_bsmu,mid_SOblique,mid_TOblique,mid_UOblique],[sige_bsmu,sige_SOblique,sige_TOblique,sige_UOblique],[sig_bsmu,sig_SOblique,sig_TOblique,sig_UOblique])
