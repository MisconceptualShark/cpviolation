...
def itera_bmumu(mt,mt_err,taubs,taubs_err,fbs,fbs_err,Vtb,Vtb_err,Vts,Vts_err,mmu,mmu_err,mbs,mbs_err,mW,mW_err,mb,mb_err,ms,ms_err,wangle,wan_err,higgs,higgs_err,v,v_err,bs_exp,bs_exp_error):
    '''
